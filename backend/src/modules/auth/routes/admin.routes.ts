...
import { getUserRoles } from '../services/session.service';

/**
 * Check if user is admin
 * Uses proper RBAC to verify user has admin or super_admin role
 */
...
/**
 * Admin auth routes plugin
 */
export const adminAuthRoutes = new Elysia({ prefix: '/api/admin/auth', name: 'admin-auth-routes' })
  .use(sessionGuard)
